...
<main class="flex-1 p-10 overflow-y-auto">
    <header class="flex justify-between items-center mb-10">
        <div>
            ...
            <p class="text-slate-500 font-medium">Atur dan kelola kategori event di platform Anda.</p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
        <div class="px-8 py-6 bg-slate-50/50 border-b">
            <form method="GET" class="flex gap-2">
                ...
                <?php if($search): ?>
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="px-6 py-3 bg-slate-200 text-slate-700 rounded-xl font-bold hover:bg-slate-300 transition">
                        Reset
                    </a>
                <?php endif; ?>
            </form>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-8 py-6 font-bold text-slate-400"><?php echo e(($categories->currentPage() - 1) * $categories->perPage() + $index + 1); ?></td>
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800"><?php echo e($category->name); ?></p>
                            <p class="text-xs text-slate-400">ID: <?php echo e($category->id); ?></p>
                        </td>
                        <td class="px-8 py-6">
                            <p class="text-sm text-slate-600"><?php echo e($category->created_at->format('d M Y')); ?></p>
                        </td>
                        <td class="px-8 py-6">
                            <p class="text-sm text-slate-600"><?php echo e($category->updated_at->format('d M Y')); ?></p>
                        </td>
                        <td class="px-8 py-6">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>