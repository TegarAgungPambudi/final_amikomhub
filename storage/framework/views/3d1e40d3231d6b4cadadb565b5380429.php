...
<div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden <?php echo e($isPast ? 'opacity-85' : ''); ?>">
    
    <div class="relative overflow-hidden aspect-[3/4] bg-slate-100">
        <img
            src="<?php echo e($event->poster_url); ?>"
    ...
    <div class="p-6">
        ...
        <div class="flex items-center gap-2 text-slate-500 text-sm mb-3">
            ...
            <span>
                <?php echo e(\Carbon\Carbon::parse($event->date)->format('d-m-Y H:i')); ?>
        ...
        <?php if($event->organization): ?>
            <div class="flex items-center gap-2 text-xs text-slate-400 mb-3">
                ...
                <a href="<?php echo e(route('organizer.profile', $event->organization->slug)); ?>" class="hover:text-orange-600 transition font-medium">
        ...
        <div class="flex justify-between items-center pt-4 border-t">
            ...
            <a href="<?php echo e(route('events.show', $event->id)); ?>" class="px-5 py-2 bg-orange-50 text-orange-600 rounded-xl font-bold hover:bg-orange-600 hover:text-white transition">
                Lihat Detail
            </a>
        </div>
    </div>
...
<?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/partials/event-card.blade.php ENDPATH**/ ?>