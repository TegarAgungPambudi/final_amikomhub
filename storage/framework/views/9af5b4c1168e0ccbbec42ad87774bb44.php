    ...
    <nav
        ...
        <div class="flex gap-3 items-center">
            <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->isOrganizer()): ?>
                    <a href="<?php echo e(auth()->user()->isOrganizer() ? route('admin.organizer.dashboard') : route('admin.dashboard')); ?>"
                ...
                <div class="flex items-center gap-3">
                    <div class="flex items-center gap-2">
                        ...
                        <?php endif; ?>
                        <span class="text-sm font-medium text-slate-700 hidden md:block"><?php echo e(auth()->user()->name); ?></span>
                    </div>
            ...
            <?php else: ?>
                ...
                <?php if(!request()->routeIs('login')): ?>
                    ...
                    <a href="<?php echo e(route('auth.google', ['redirect' => request()->fullUrl()])); ?>"
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="/?category=<?php echo e($cat->slug); ?>" class="hover:text-white transition"><?php echo e($cat->name); ?></a></li>
...
<?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/layouts/app.blade.php ENDPATH**/ ?>