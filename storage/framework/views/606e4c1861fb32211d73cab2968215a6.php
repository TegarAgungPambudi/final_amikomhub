...
<?php $__env->startSection('content'); ?>
    <main class="max-w-7xl mx-auto px-6 py-12">
        <!-- Back Button -->
        <a href="<?php echo e(url()->previous()); ?>" class="inline-flex items-center gap-2 text-slate-500 hover:text-orange-600 font-medium mb-8 transition">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 md:p-12 mb-10">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div class="flex-1 text-center md:text-left">
                    <h1 class="text-3xl md:text-4xl font-black mb-2"><?php echo e($organization->name); ?></h1>
                    <p class="text-slate-500 mb-4 max-w-2xl"><?php echo e($organization->description ?? 'Penyelenggara event terpercaya di Amikom'); ?></p>
                    ...
                    <div class="flex flex-wrap justify-center md:justify-start gap-6">
                        ...
                        <div class="flex items-center gap-2 text-slate-600">
                            ...
                            <span class="font-bold"><?php echo e($totalEvents); ?></span>
                        ...
                        <div class="flex items-center gap-2 text-slate-600">
                            ...
                            <span class="text-sm text-slate-400">(<?php echo e($totalReviews); ?> ulasan)</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-slate-600">
                            ...
                            <span class="text-sm">Bergabung <?php echo e($organization->created_at->format('M Y')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Events List -->
        <div class="mb-10">
            <h3 class="text-2xl font-black mb-6">Event oleh <?php echo e($organization->name); ?></h3>
                    ...
                    <div class="group bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
                        <div class="relative overflow-hidden aspect-[3/4] bg-slate-100">
                            ...
                            <div class="absolute top-3 left-3 px-3 py-1 bg-white/90 backdrop-blur rounded-lg text-xs font-bold uppercase text-orange-600">
                                <?php echo e($event->category->name ?? 'Event'); ?>
                            ...
                            <?php if($eventReviewCount > 0): ?>
                                <div class="absolute bottom-3 left-3 px-3 py-1 bg-white/90 backdrop-blur rounded-lg text-xs font-bold flex items-center gap-1">
                                    ...
                                    <?php echo e(number_format($eventAvgRating, 1)); ?>
                        ...
                        <div class="p-5">
                            <h4 class="font-bold mb-2 group-hover:text-orange-600 transition"><?php echo e($event->title); ?></h4>
                            
                            <div class="flex items-center gap-1 text-slate-500 text-xs mb-3">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span><?php echo e($event->date ? $event->date->format('d M Y') : 'TBA'); ?></span>
                            </div>
                            ...
                            <div class="flex justify-between items-center pt-3 border-t">
                                ...
                                <a href="<?php echo e(route('events.show', $event->id)); ?>" class="text-xs font-bold text-orange-600 hover:underline">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Recent Reviews -->
        <div>
            <h3 class="text-2xl font-black mb-6">Ulasan Terbaru untuk <?php echo e($organization->name); ?></h3>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs font-medium text-orange-500 mb-2">
                                    pada event: <a href="<?php echo e(route('events.show', $review->event_id)); ?>" class="hover:underline"><?php echo e($review->event->title ?? 'Event'); ?></a>
                                </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/organizer-profile.blade.php ENDPATH**/ ?>