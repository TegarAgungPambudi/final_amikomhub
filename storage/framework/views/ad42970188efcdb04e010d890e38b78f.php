...
<?php $__env->startSection('page_title', 'Tambah Kupon Baru'); ?>
<?php $__env->startSection('page_subtitle', 'Buat kode diskon untuk menarik lebih banyak pembeli.'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="code" value="<?php echo e(old('code')); ?>" 
                       ...
                       placeholder="CONTOH50" required>
                <p class="text-[10px] text-slate-400 mt-2 font-bold uppercase">Gunakan huruf kapital, tanpa spasi</p>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="description" rows="2" 
                      class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium"><?php echo e(old('description')); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="discount_type" 
                    ...
                    <option value="percent" <?php echo e(old('discount_type') === 'percent' ? 'selected' : ''); ?>>Persen (%)</option>
                    <option value="fixed" <?php echo e(old('discount_type') === 'fixed' ? 'selected' : ''); ?>>Nominal Tetap (Rp)</option>
                </select>
            </div>
            <div>
                ...
                <input type="number" name="discount_value" value="<?php echo e(old('discount_value')); ?>" 
                       class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" 
                       placeholder="10 (untuk 10%)" required min="1">
                <p class="text-[10px] text-slate-400 mt-2 font-bold uppercase">Persen: 1-100 | Nominal: Rupiah</p>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" name="max_uses" value="<?php echo e(old('max_uses', 0)); ?>" 
            ...
            <div>
                ...
                <input type="number" name="min_order_amount" value="<?php echo e(old('min_order_amount', 0)); ?>" 
                       class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" min="0">
                <p class="text-[10px] text-slate-400 mt-2 font-bold uppercase">0 = Tanpa minimal</p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/admin/coupons/create.blade.php ENDPATH**/ ?>