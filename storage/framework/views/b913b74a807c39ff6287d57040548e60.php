<?php $__env->startSection('title', 'Kelola Event - Admin'); ?>

<?php $__env->startSection('page_title', 'Kelola Event'); ?>
<?php $__env->startSection('page_subtitle', 'Buat dan atur acara seru Anda di sini.'); ?>
            ...
            <tbody class="divide-y border-t">
                <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            <img src="<?php echo e($event->poster_url); ?>" class="w-16 h-20 rounded-xl object-cover shadow-sm" alt="<?php echo e($event->title); ?>">
                        </td>
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800"><?php echo e($event->title); ?></p>
                            <p class="text-xs text-slate-400">
                                <?php echo e($event->category->name ?? 'Tanpa Kategori'); ?> • <?php echo e($event->date->format('d M Y')); ?>
                        ...
                        <td class="px-8 py-6">
                            <div class="flex justify-center items-center gap-2">
                                <a href="<?php echo e(route('admin.events.edit', $event->id)); ?>" class="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition shadow-sm">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </a>

                                <form action="<?php echo e(route('admin.events.destroy', $event->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus acara ini?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/admin/events/index.blade.php ENDPATH**/ ?>