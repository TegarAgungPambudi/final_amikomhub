...
<?php $__env->startSection('page_title', 'Edit Organizer'); ?>
<?php $__env->startSection('page_subtitle', 'Perbarui data penyelenggara event'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl">
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
        <form action="<?php echo e(route('admin.organizers.update', $user)); ?>" method="POST" class="space-y-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="role"
                    class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium"
                    required>
                    <option value="organizer" <?php echo e(old('role', $user->role) == 'organizer' ? 'selected' : ''); ?>>Organizer</option>
                    <option value="admin" <?php echo e(old('role', $user->role) == 'admin' ? 'selected' : ''); ?>>Superadmin</option>
                </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/admin/organizers/edit.blade.php ENDPATH**/ ?>