<?php $__env->startSection('title', 'Edit Event - Admin'); ?>

<?php $__env->startSection('page_title', 'Edit Event'); ?>
<?php $__env->startSection('page_subtitle', 'Ubah detail acara.'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="description" rows="4" 
                      class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium"><?php echo e(old('description', $event->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="datetime-local" name="date" value="<?php echo e(old('date', $event->date->format('Y-m-d\TH:i'))); ?>" 
                       class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" 
                       required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="stock" value="<?php echo e(old('stock', $event->stock)); ?>" 
                       class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" 
                       required min="1">
        ...
        <div>
            ...
            <?php if($event->poster_path): ?>
                <div class="flex items-center gap-2 mt-3 p-3 bg-slate-50 rounded-xl border border-dashed">
                    ...
                    <a href="<?php echo e($event->poster_url); ?>" target="_blank" class="text-indigo-600 text-xs font-bold hover:underline flex items-center gap-1">
                        Lihat Gambar
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/admin/events/edit.blade.php ENDPATH**/ ?>