...
<main id="checkoutPage" class="max-w-6xl mx-auto px-6 py-12 lg:py-20"
      data-event-price="<?php echo e((int) $currentPrice); ?>"
      data-checkout-route="<?php echo e(route('checkout.process', $event)); ?>"
      data-payment-status-route="<?php echo e(route('payment.status', ['transaction' => ':id'])); ?>"
      data-demo="<?php echo e(config('midtrans.is_demo') ? '1' : '0'); ?>"
      data-is-past="<?php echo e($event->date && $event->date->isPast() ? '1' : '0'); ?>">
    <div class="mb-10">
        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 text-orange-600 font-bold mb-6 hover:text-orange-700 transition">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8">
        <div class="bg-white rounded-[2rem] border border-slate-200 p-8 shadow-sm">
            ...
            <div class="flex flex-col md:flex-row gap-6 items-start">
                <img src="<?php echo e($event->poster_url); ?>" alt="<?php echo e($event->title); ?>" class="w-full md:w-32 h-32 rounded-2xl object-cover shadow-sm">
                <div class="flex-1">
                    <h4 class="font-extrabold text-lg text-slate-900"><?php echo e($event->title); ?></h4>
                    <p class="text-slate-500 mt-1">
                        <?php echo e($event->date ? $event->date->format('d M Y H:i') : 'Tanggal belum diatur'); ?> • <?php echo e($event->location); ?>

                    </p>
                    <p class="text-orange-600 font-bold mt-3" id="ticketSummaryLine">1 x Rp <?php echo e(number_format($currentPrice, 0, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-slate-100 space-y-3">
                <div class="flex justify-between text-slate-600">
                    ...
                    <span id="ticketPriceText">Rp <?php echo e(number_format($currentPrice, 0, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between text-slate-600">
                ...
                <div class="flex justify-between text-2xl font-black mt-4 pt-4 border-t border-slate-100">
                    ...
                    <span class="text-orange-600" id="totalPriceText">Rp <?php echo e(number_format($event->price, 0, ',', '.')); ?></span>
                </div>
            </div>
        </div>
            ...
            <form id="checkoutForm" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <input type="hidden" id="eventIdInput" value="<?php echo e($event->id); ?>">
                ...
                <?php if(config('midtrans.is_demo')): ?>
                ...
                <?php if($event->date && $event->date->isPast()): ?>
...
<?php endif; ?>
<script src="<?php echo e(asset('assets/checkout.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\finalproject_amikomhub\resources\views/checkout.blade.php ENDPATH**/ ?>