    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex gap-6">
            <div class="text-center">
                <span class="text-2xl font-black text-orange-600">{{ $organizationCount }}</span>
                <p class="text-xs text-orange-500 font-bold">Organisasi</p>
            </div>
            <div class="text-center">
                <span class="text-2xl font-black text-orange-600">{{ $organizerCount }}</span>
                <p class="text-xs text-orange-500 font-bold">Organizer</p>
            </div>
            <a href="{{ route('admin.organizers.index') }}" class="px-4 py-2 bg-orange-500 text-white rounded-xl font-bold text-sm hover:bg-orange-600 transition self-center">
                Kelola Organizer
            </a>
        </div>
    </div>
...
<div class="bg-white rounded-3xl border border-orange-100 shadow-sm overflow-hidden">
    <div class="p-8 border-b border-orange-100 flex justify-between items-center">
        ...
        <a href="{{ route('admin.transactions.index') }}" class="text-orange-600 font-bold hover:underline">Lihat Semua</a>
    </div>
            ...
            <tbody class="divide-y border-t">
                @forelse($recentTransactions as $trx)
                    <tr class="hover:bg-orange-50/60 transition">
                        ...
                        <td class="px-8 py-6 font-black text-orange-600">Rp {{ number_format($trx->total_price, 0, ',', '.') }}</td>
                    </tr>
                @empty
                    <tr>
